...
# OpenPipeStress build configuration file, created by
# `ablog start` on Tue Nov 25 17:56:18 2025.
#
...
extensions = [
    ...
    'alabaster',
    'ablog',
    'jupyter_sphinx',   # for jupyter-execute and thebelab
    'nbsphinx',         # to include .ipynb files
]
...
htmlhelp_basename = "OpenPipeStressdoc"
